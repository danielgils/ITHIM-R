# Script to get physical activity data in the cities made by Daniel in the World Bank
# August 2020
...
# Defined MMETs for each activity
...
# Colombia - ENSIN: National Survey of Nutritional Situation
# Household: to get location information of the respondents
hogar <- read_csv("C:/Users/danie/Documents/Daniel_Gil/Consultorias/2020/WorldBank/Data/Colombia/PhysicalActivity/base-ensin-2015-publica/Formato_Stata/PTS.csv")
# Person: demographic information of the respondents
persona <- read_csv("C:/Users/danie/Documents/Daniel_Gil/Consultorias/2020/WorldBank/Data/Colombia/PhysicalActivity/base-ensin-2015-publica/Formato_Stata/PTS_2.csv")
# preescolar: PA for kids between 3 and 5 years old
preescolar <- read_csv("C:/Users/danie/Documents/Daniel_Gil/Consultorias/2020/WorldBank/Data/Colombia/PhysicalActivity/base-ensin-2015-publica/Formato_Stata/AF_PREESCOLARES.csv")
# escolar: PA for kids between 6 and 12 years old
escolar <- read_csv("C:/Users/danie/Documents/Daniel_Gil/Consultorias/2020/WorldBank/Data/Colombia/PhysicalActivity/base-ensin-2015-publica/Formato_Stata/AF_ESCOLARES.csv")
# adoles: PA for teenagers (between 13 and 17 years old)
adoles <- read_csv("C:/Users/danie/Documents/Daniel_Gil/Consultorias/2020/WorldBank/Data/Colombia/PhysicalActivity/base-ensin-2015-publica/Formato_Stata/AF_ADOLESCENTES.csv")
# adulto: PA for everyone else (18 to 64 years old)
adulto <- read_csv("C:/Users/danie/Documents/Daniel_Gil/Consultorias/2020/WorldBank/Data/Colombia/PhysicalActivity/base-ensin-2015-publica/Formato_Stata/AF_ADULTOS.csv")
# gestante: PA for pregnant women
gestante <- read_csv("C:/Users/danie/Documents/Daniel_Gil/Consultorias/2020/WorldBank/Data/Colombia/PhysicalActivity/base-ensin-2015-publica/Formato_Stata/AF_GESTANTES.csv")
gestante2 <- read_csv("C:/Users/danie/Documents/Daniel_Gil/Consultorias/2020/WorldBank/Data/Colombia/PhysicalActivity/base-ensin-2015-publica/Formato_Stata/AF_A_GESTANTES.csv")


#' Se hace el filtro de los datos para cada ciudad
#####
#' *Hogares*
